...
type Period struct {
	...
	ExcessReturn          float64 `json:"excess_return" mapstructure:"excess_return"`
...
type Result struct {
	Periods []Period `json:"periods" mapstructure:"periods"`
}
...
type Engine interface {
	...
	GetPortfolio() (*backtest_pb.GetPortfolioResponse, error)
	Continue(*[]Order) error

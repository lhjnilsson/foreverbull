...
var file_foreverbull_backtest_session_proto_rawDesc = []byte{
	...
	0x67, 0x2f, 0x70, 0x62, 0x2f, 0x62, 0x61, 0x63, 0x6b, 0x74, 0x65, 0x73, 0x74, 0x62, 0x06, 0x70,
...
func file_foreverbull_backtest_session_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_foreverbull_backtest_session_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_foreverbull_backtest_session_proto_msgTypes[1].Exporter = func(v any, i int) any {

...
type SessionServicerClient interface {
	...
	StoreResult(ctx context.Context, in *StoreExecutionResultRequest, opts ...grpc.CallOption) (*StoreExecutionResultResponse, error)
...
func (c *sessionServicerClient) StoreResult(ctx context.Context, in *StoreExecutionResultRequest, opts ...grpc.CallOption) (*StoreExecutionResultResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(StoreExecutionResultResponse)
	err := c.cc.Invoke(ctx, SessionServicer_StoreResult_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSessionServicerServer) StoreResult(context.Context, *StoreExecutionResultRequest) (*StoreExecutionResultResponse, error) {
...
func _SessionServicer_StoreResult_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StoreExecutionResultRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SessionServicerServer).StoreResult(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SessionServicer_StoreResult_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SessionServicerServer).StoreResult(ctx, req.(*StoreExecutionResultRequest))
	}
	return interceptor(ctx, in, info, handler)
}

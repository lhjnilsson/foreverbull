...
func (_m *MockReplier) Receive(msg protoreflect.ProtoMessage, opt ...func(OptionSetter) error) (ReplierSocket, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(protoreflect.ProtoMessage, ...func(OptionSetter) error) (ReplierSocket, error)); ok {
		return rf(msg, opt...)
	}

...
func (_m *Container) Start(ctx context.Context, image string, containerID string, extraLabels map[string]string) (string, error) {
	...
	if rf, ok := ret.Get(0).(func(context.Context, string, string, map[string]string) (string, error)); ok {
		return rf(ctx, image, containerID, extraLabels)
	}

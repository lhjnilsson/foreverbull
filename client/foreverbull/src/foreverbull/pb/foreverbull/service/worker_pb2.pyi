    ...
    class Function(_message.Message):
        ...
        def __init__(
            ...
            parameters: _Optional[
                _Iterable[_Union[Algorithm.FunctionParameter, _Mapping]]
            ] = ...,
            parallelExecution: bool = ...,
            runFirst: bool = ...,
            runLast: bool = ...,
...
class ExecutionConfiguration(_message.Message):
    ...
    class Function(_message.Message):
        ...
        name: str
        parameters: _containers.RepeatedCompositeFieldContainer[
            ExecutionConfiguration.FunctionParameter
        ]
        def __init__(
            self,
            name: _Optional[str] = ...,
            parameters: _Optional[
                _Iterable[_Union[ExecutionConfiguration.FunctionParameter, _Mapping]]
            ] = ...,
        ) -> None: ...
    ...
    functions: _containers.RepeatedCompositeFieldContainer[
        ExecutionConfiguration.Function
    ]
    def __init__(
        self,
        ...
        functions: _Optional[
            _Iterable[_Union[ExecutionConfiguration.Function, _Mapping]]
        ] = ...,
    ) -> None: ...

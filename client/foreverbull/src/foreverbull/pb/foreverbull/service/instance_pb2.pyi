...
class Instance(_message.Message):
    ...
    class Status(_message.Message):
        ...
        def __init__(
            self,
            status: _Optional[_Union[Instance.Status.Status, str]] = ...,
            error: _Optional[str] = ...,
            OccurredAt: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...,
        ) -> None: ...
    ...
    def __init__(
        ...
        Host: _Optional[str] = ...,
        Port: _Optional[int] = ...,
        statuses: _Optional[_Iterable[_Union[Instance.Status, _Mapping]]] = ...,
    ) -> None: ...

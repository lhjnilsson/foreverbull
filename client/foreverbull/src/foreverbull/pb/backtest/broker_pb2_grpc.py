...
class BrokerSessionStub(object):
    """Missing associated documentation comment in .proto file."""
    ...
    def __init__(self, channel):
        ...
        self.CreateExecution = channel.unary_unary(
            "/foreverbull.pb.backtest.BrokerSession/CreateExecution",
        ...
        self.RunExecution = channel.unary_stream(
            "/foreverbull.pb.backtest.BrokerSession/RunExecution",
        ...
        self.GetExecution = channel.unary_unary(
            "/foreverbull.pb.backtest.BrokerSession/GetExecution",
...
class BrokerSessionServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_BrokerSessionServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler("foreverbull.pb.backtest.BrokerSession", rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers("foreverbull.pb.backtest.BrokerSession", rpc_method_handlers)


# This class is part of an EXPERIMENTAL API.
class BrokerSession(object):
    """Missing associated documentation comment in .proto file."""
